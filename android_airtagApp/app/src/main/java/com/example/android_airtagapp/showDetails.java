 ...
 * Use the {@link showDetails#newInstance} factory method to
...
public class showDetails extends Fragment {
    ...
    public static showDetails newInstance(String param1, String param2) {
        showDetails fragment = new showDetails();
